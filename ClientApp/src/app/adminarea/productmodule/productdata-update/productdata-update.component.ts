...
export class ProductdataUpdateComponent implements OnInit {
  ...
  constructor(private snackBar: MatSnackBar,private route: ActivatedRoute, private productService: ProductdataserviceService, private formBuilder: FormBuilder, public _router: Router) { }
